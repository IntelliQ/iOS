...
////            if let json = NSJSONSerialization.JSONObjectWithData(result, options: .MutableLeaves) as? [String:AnyObject] {
////                if let companyResult = json["companies"] as? [ [String:AnyObject] ]{
////                    for company in companyResult  {
////                        let newCompany:Company = Company()
////                        
...
////            var json = NSJSONSerialization.JSONObjectWithData(result, options: .MutableLeaves) as? [String:AnyObject]
...
////                            position = Int((person["position__c"] as! String))!
////                            
////                        }
////                    }
////                    
////                    var personAhead = 0
////                    for person in persons{
////                        if Int((person["position__c"] as! String)) < position {
////                            personAhead++
////                        }
////                    }
////                    
