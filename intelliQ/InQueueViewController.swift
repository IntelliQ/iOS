...
//                    let minutes = self.companyAvgTime! * Int((result["peopleAhead"])!)!
...
//        notifyUser()
//        let alert = UIAlertController(title: "\(companyName!)", message: "your_turn".localized, preferredStyle: UIAlertControllerStyle.Alert)
...
//            defaults.setObject(newQueues, forKey: "queues")
//        }else{
//            let queues:[String:String] = [companyId!: waitingId!]
